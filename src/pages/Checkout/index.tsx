              ...
              <S.Row>
                <S.InputGroup>
                  ...
                  <input
                    ...
                    className={checkInputHasErros('fullName') ? 'error' : ''}
                  />
                </S.InputGroup>
                <S.InputGroup>
                  ...
                  <input
                    ...
                    onChange={form.handleChange}
                    onBlur={form.handleBlur}
                    className={checkInputHasErros('email') ? 'error' : ''}
                  />
                </S.InputGroup>
                <S.InputGroup>
                  ...
                  <InputMask
                    ...
                    onChange={form.handleChange}
                    onBlur={form.handleBlur}
                    className={checkInputHasErros('cpf') ? 'error' : ''}
                    mask="999.999.999-99"
                  />
                </S.InputGroup>
              </S.Row>
              ...
              <S.Row>
                <S.InputGroup>
                  ...
                  <input
                    ...
                    onBlur={form.handleBlur}
                    className={
                      checkInputHasErros('deliveryEmail') ? 'error' : ''
                    }
                  />
                </S.InputGroup>
                <S.InputGroup>
                  ...
                  <input
                    ...
                    onBlur={form.handleBlur}
                    className={
                      checkInputHasErros('confirmDeliveryEmail') ? 'error' : ''
                    }
                  />
                </S.InputGroup>
              </S.Row>
                    ...
                    <S.Row>
                      <S.InputGroup>
                        ...
                        <input
                          ...
                          onBlur={form.handleBlur}
                          className={
                            checkInputHasErros('cardOwner') ? 'error' : ''
                          }
                        />
                      </S.InputGroup>
                      <S.InputGroup>
                        ...
                        <InputMask
                          ...
                          onBlur={form.handleBlur}
                          className={
                            checkInputHasErros('cpfCardOwner') ? 'error' : ''
                          }
                          mask="999.999.999-99"
                        />
                      </S.InputGroup>
                    ...
                    <S.Row marginTop="24px">
                      <S.InputGroup>
                        ...
                        <input
                          ...
                          onBlur={form.handleBlur}
                          className={
                            checkInputHasErros('cardDisplayName') ? 'error' : ''
                          }
                        />
                      </S.InputGroup>
                      <S.InputGroup>
                        ...
                        <InputMask
                          ...
                          onBlur={form.handleBlur}
                          className={
                            checkInputHasErros('cardNumber') ? 'error' : ''
                          }
                      ...
                      <S.InputGroup maxWidth="123px">
                        ...
                        <InputMask
                          ...
                          onBlur={form.handleBlur}
                          className={
                            checkInputHasErros('expiresMonth') ? 'error' : ''
                          }
                          mask="99"
                        />
                      </S.InputGroup>
                      ...
                      <S.InputGroup maxWidth="48px">
                        ...
                        <InputMask
                          ...
                          onBlur={form.handleBlur}
                          className={
                            checkInputHasErros('cardCode') ? 'error' : ''
                          }
                          mask="999"
                        />
                      </S.InputGroup>
